...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_heartgryphon_dsp_internal_user.UserResponse"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "github_com_heartgryphon_dsp_internal_user.UserResponse": {
            "type": "object",
            "properties": {
                "advertiser_id": {
                    "type": "integer"
